...
class Kml():
    ...
    def process_colorstyle_attributes(self, colorstyle, params):
        ...
        # process attributes of the object abstract element  
        colorstyle = self.process_object_attributes(colorstyle, params)
    
        # there are no attributes specific to the StyleSelector element
        for key in params:
            if key == 'color':
    ...
    """
    def process_container_attributes(self, container, params):

        # process attributes of the feature abstract element  
        container = self.process_feature_attributes(container, params)

        # process attributes of the abstract container element  
        for key in params:
            if key == 'folder' or key == 'document' or key == 'photooverlay' or key == 'screenoverlay' or key == 'groundoverlay' or key == 'placemark' or key == 'networklink' or key == 'gxtour':
                if isinstance(params[key],list):
                    # process multiple features if needed
    ...
    def create_document(self, params={}):
        ...
        for key in params:
            if key == 'folder' or key == 'document' or key == 'photooverlay' or key == 'screenoverlay' or key == 'groundoverlay' or key == 'placemark' or key == 'networklink' or key == 'gxtour':
                ...
                if isinstance(params[key],list):
                    # process multiple styles if needed
                    for x in params[key]:
                        document.add_styleselector(x)
                else:
                    document.add_styleselector(params[key])
            elif key == 'schema':
                if isinstance(params[key],list):
        ...
        document = self.process_container_attributes(document,params)
        return document
    """ --------------------------------------------------------------
    ...
    """
    def process_feature_attributes(self, feature, params):
        """
    ...
    def create_folder(self, params = {} ):
        ...
        # process folder element attributes 
        for key in params:
            if key == 'folder' or key == 'document' or key == 'photooverlay' or key == 'screenoverlay' or key == 'groundoverlay' or key == 'placemark' or key == 'networklink' or key == 'gxtour':
                if isinstance(params[key],list):
                    # process multiple folders if needed
                    for x in params[key]:
